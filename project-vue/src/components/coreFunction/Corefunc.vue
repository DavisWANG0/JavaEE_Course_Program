      ...
      <el-carousel height="350px" direction="horizontal" :autoplay="true" arrow="never">
        <el-carousel-item v-for="item in 1" :key="item">
          ...
          <el-descriptions :column="1" direction="horizontal" labelClassName="my-label" contentClassName="my-label" align="center">
            ...
            <el-descriptions-item label="开户时间" label-class-name="my-label" align="center">{{bankAccountInfo.openDate}}</el-descriptions-item>
            <el-descriptions-item label="状态" labelClassName="my-label" >
              <el-tag size="small">{{bankAccountInfo.state}}</el-tag>
            </el-descriptions-item>
            <el-descriptions-item label="账户余额" label-class-name="my-label" align="center">{{bankAccountInfo.balance}}</el-descriptions-item>
          </el-descriptions>
        ...
        >
          ...
          >
            ...
            <div style="padding: 4px">
              <el-link type="success">{{ name[index] }}</el-link>
